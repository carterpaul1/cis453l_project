...
import { ReactComponent as WavyFlag } from './wavyflag.svg';
import './App.css';
...
const DynamicImageDisplay = () => {
  ...
  return (
    <div className="dynamic-image-display">
      <button onClick={handleShowImage}>Click Here to See Coffee with American Flag</button>
      {showImage && (
        <img
          src={`${process.env.PUBLIC_URL}/coffeeflag.webp`}
          alt="Dynamic Coffee Image"
        />
      )}
    </div>
  );
    ...
    <div className="App">
      <header className="App-header">
        <h1>
          ...
          <WavyFlag className="FlagSVGLogo" />
        </h1>
      </header>
